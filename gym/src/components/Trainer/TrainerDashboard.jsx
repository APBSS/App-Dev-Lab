    ...
    <div className="tdashboard-container">
        ...
        {isMenuOpen && (
          <div className="menu-content">
            <ul>
              ...
              <li onClick={() => handleMenuClick('/trainer-settings')}>Settings</li>
      ...
      <div className="dashboard-grid">
        ...
        <Link to="/client-management" className="dashboard-card feed" style={{textDecoration:"none"}}>
          ...
          <ul className="dashboard-list">
            {['Track Client Progress', 'Manage Client Feedback', 'Assess Training Results'].map(
              (task, index) => (
        ...
        <div className="dashboard-card white-theme">
          ...
          <ul className="dashboard-list white-theme">
            <li className="dashboard-list-item white-theme report">Client workout performance reports</li>
            <li className="dashboard-list-item white-theme report">Diet plan adherence summaries</li>
            <li className="dashboard-list-item white-theme report">Overall progress tracking</li>
          </ul>
